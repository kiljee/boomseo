        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-8">
          <div className="lg:mb-18 mx-auto max-w-3xl text-center">
            <h1 className="text-foreground text-5xl font-bold sm:text-6xl">
              Grow your <span className="text-gradient-primary">Organic Traffic</span>{" "}
              with AI-powered SEO
            </h1>
            <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-lg leading-8">
              Analyze your website, discover high-impact keywords, track rankings,
          audit technical SEO issues, and optimize your content—all from one
          intuitive platform.
            </p>
